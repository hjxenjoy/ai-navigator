    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: '🗺️ 学习路径推荐', link: '/learning-paths' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '2.12 AI 产品的 UX 设计模式', link: '/ch2-build-products/ai-ux' },
          { text: '2.13 语义缓存', link: '/ch2-build-products/semantic-cache' },
          { text: '2.14 限流、重试与熔断', link: '/ch2-build-products/retry-ratelimit' },
          { text: '2.15 Guardrails 输出防护实战', link: '/ch2-build-products/guardrails' },
      ...
      {
        text: '第 5 章 · 四大专题深入（RAG / MCP / Skill / 微调）',
        collapsed: true,
        items: [
          {
            text: 'RAG 进阶（5.1–5.5、5.17、5.19）',
            collapsed: true,
            items: [
              ...
              { text: '5.19 Text-to-SQL 与结构化数据对话', link: '/ch5-deep-dives/text-to-sql' },
              { text: '5.20 DSPy 与自动化 Prompt 优化', link: '/ch5-deep-dives/dspy-apo' },
            ],
          },
          {
            text: 'MCP 进阶（5.6–5.9）',
